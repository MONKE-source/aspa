...
<html>
  <head>
    ...
    <style type="text/css">
      ...
      table.sheet0 col.col0 {
        width: 121.32222083pt;
      }
      table.sheet0 col.col1 {
        width: 209.43333093pt;
      }
  ...
  <body>
    <style>
      @page {
        margin-left: 0.74803149606299in;
        margin-right: 0.74803149606299in;
        margin-top: 0in;
        margin-bottom: 0in;
      }
      body {
    ...
    >
      ...
      <tbody>
        ...
        <tr class="row12">
          ...
          <td class="column1 style63 s">
            TCI - Draw up 2mg in 50 ml for infusion
          </td>
        ...
        <tr class="row15">
          ...
          <td class="column1 style81 s">
            Draw 200 mcg in 50 ml. Use BBraun Infusion Pump &quot;<span
              style="
                font-style: italic;
                color: #000000;
                font-family: 'Calibri';
        ...
        <tr class="row21">
          ...
          <td class="column4 style116 s style118" colspan="3">
        ...
        <tr class="row22">
          <td class="column0 style3 s">
            Tranexemic acid (<span
              style="
                font-weight: bold;
                color: #000000;
                font-family: 'Symbol';
          ...
          <td class="column4 style110 s style112" colspan="3">
            (10ml/hr for 1hr then 1ml/hr)
          </td>
          <td class="column7">&nbsp;</td>
          <td class="column8">&nbsp;</td>
        ...
        <tr class="row24">
          ...
          <td class="column1 style108 s style109" rowspan="2">
        ...
        <tr class="row26">
          ...
          <td class="column1 style4 s">
            ( 50 mg Morphine + 50 mg Ketamine ) / 50ml
          </td>
    ...
    >
      ...
      <tbody>
        ...
        <tr class="row4">
          ...
          <td class="column4 style19 f">
            ${roundOff(Math.min(6, weight * 0.1), 2)}
          </td>
          <td class="column5 style26 s">mg</td>
          <td class="column6 style27 s style23" colspan="3">
            first bolus (max 6 mg)
          </td>
        </tr>
        <tr class="row5">
          <td class="column0 style1 null"></td>
          ...
          <td class="column4 style19 f">
            ${roundOff(Math.min(12, weight * 0.2), 2)}
          </td>
          <td class="column5 style26 s">mg</td>
          <td class="column6 style27 s style23" colspan="3">
            second bolus (max 12mg)
          </td>
        </tr>
        <tr class="row6">
          <td class="column0 style1 null"></td>
        ...
        <tr class="row14">
          ...
          <td class="column6 style35 s mgso4-remarks">
            Dilute to 100mg/ml, infuse over 1-hour, Max 2000mg
          </td>
          <td class="column7 style30 null"></td>
        ...
        <tr class="row15">
          ...
          <td class="column5 style20 s">mg</td>
          <td class="column6 style37 s style23" colspan="3">
            ONLY BY CONSULTANT
          </td>
        </tr>
        <tr class="row16">
        ...
        <tr class="row26">
          ...
          <td class="column6 style49 s style23" colspan="3">
            Titrate to effect 0-200mcg/kg/min
          </td>
        </tr>
        <tr class="row27">
        ...
        <tr class="row31">
          ...
          <td class="column6 style21 s style23" colspan="3">
            Check dose with pharmacy
          </td>
        </tr>
        <tr class="row32">
          <td class="column0 style1 null"></td>
        ...
        <tr class="row45">
          <td class="column0 style1 null"></td>
          <td class="column1 style76 s style23" colspan="2">
            Fibrinogen (Haemocomplettan)
          </td>
          <td class="column3 style77 s">
            <span
              style="
                color: #000000;
                font-family: 'Helvetica Neue';
          ...
          <td class="column5 style26 s">mg</td>
          <td class="column6 style78 s style23" colspan="3">
            <span
              style="
                color: #000000;
                font-family: 'Helvetica Neue';
          ...
          <td class="column6 style78 s style23" colspan="3">
            <span
              style="
                ...
                font-size: 9pt;
              "
              >- Consider initial dose 20-40mcg/kg ; Redosed Q2H<br />
              - Capped at 180 mcg/kg/</span
            ><span
              style="
                font-weight: bold;
                color: #000000;
